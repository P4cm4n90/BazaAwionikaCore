...
{
    public class EltFunctionalTestMappingProfile : Profile
    {
        public EltFunctionalTestMappingProfile()
        {
            CreateMap<EltFunctionalTestViewModel, EltFunctionalTestModel>()
        ...
        {
            get { return "EltFunctionalTestMappingProfile"; }
        }
    }
}
