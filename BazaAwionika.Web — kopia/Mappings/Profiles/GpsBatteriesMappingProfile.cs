...
{
    public class GpsBatteriesMappingProfile : Profile
    {
        public GpsBatteriesMappingProfile()
        {
            CreateMap<GpsBatteriesViewModel, GpsBatteriesModel>()
        ...
        {
            get { return "GpsBatteriesMappingProfile"; }
        }
    }
}