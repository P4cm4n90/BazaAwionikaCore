...
{
    public class EgpwsDatabaseMappingProfile : Profile
    {
        public EgpwsDatabaseMappingProfile()
        {
            CreateMap<EgpwsDatabaseViewModel, EgpwsDatabaseModel>()
               .ForMember(a => a.Id, map => map.MapFrom(vm => vm.Id))
               .ForMember(a => a.DatabaseName, map => map.MapFrom(vm => vm.DatabaseName))
        ...
        {
            get { return "EgpwsDatabaseMappingProfile"; }
        }
    }
}