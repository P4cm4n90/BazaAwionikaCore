...
{
    public class GpsPCodesMappingProfile : Profile
    {
        public GpsPCodesMappingProfile()
        {
            CreateMap<GpsPCodesViewModel, GpsPCodesModel>()
        ...
        {
            get { return "GpsPCodesMappingProfile"; }
        }
    }
}