...
{
    public class OxygenExchangeMappingProfile : Profile
    {
        public OxygenExchangeMappingProfile()
        {
            CreateMap<OxygenExchangeViewModel, OxygenExchangeModel>()
        ...
        {
            get { return "OxygenExchangeMappingProfile"; }
        }
    }
}